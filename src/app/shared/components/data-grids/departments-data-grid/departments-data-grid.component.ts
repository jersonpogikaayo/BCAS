...
@Component({
  selector: 'app-departments-data-grid',
  templateUrl: './departments-data-grid.component.html',
  styleUrls: ['./departments-data-grid.component.scss']
})
export class DepartmentsDataGridComponent implements OnInit {
    ...
    private _gridItems: Department[] = [];
    
    @Input() 
      set gridItems(value: Department[]) {
        const previousLength = this._gridItems.length;
        this._gridItems = value || [];
      }
    
    get gridItems(): Department[] {
