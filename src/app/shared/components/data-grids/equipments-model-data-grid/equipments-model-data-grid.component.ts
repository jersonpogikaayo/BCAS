...
@Component({
  selector: 'app-equipments-model-data-grid',
  templateUrl: './equipments-model-data-grid.component.html',
  styleUrls: ['./equipments-model-data-grid.component.scss']
})
export class EquipmentsModelDataGridComponent implements OnInit {
