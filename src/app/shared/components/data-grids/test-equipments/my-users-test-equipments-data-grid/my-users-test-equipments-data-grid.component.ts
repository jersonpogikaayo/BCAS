...
@Component({
  selector: 'app-my-users-test-equipments-data-grid',
  templateUrl: './my-users-test-equipments-data-grid.component.html',
  styleUrls: ['./my-users-test-equipments-data-grid.component.scss']
})
export class MyUsersTestEquipmentsDataGridComponent implements OnInit {
