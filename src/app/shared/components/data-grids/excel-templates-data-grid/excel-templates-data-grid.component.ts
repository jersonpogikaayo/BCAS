...
@Component({
  selector: 'app-excel-templates-data-grid',
  templateUrl: './excel-templates-data-grid.component.html',
  styleUrls: ['./excel-templates-data-grid.component.scss']
})
export class ExcelTemplatesDataGridComponent implements OnInit {
  ...
  selectedItems: any[] = [];
  selectedItemIds: Set<string | number> = new Set();
  constructor(
