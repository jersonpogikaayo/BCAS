...
import { NgbdAssignAndBookJobModalComponent } from '../../jobs/ngbd-assign-and-book-job-modal/ngbd-assign-and-book-job-modal.component';
import { NgbdCannotLocateJobModalComponent } from '../../jobs/ngbd-cannot-locate-job-modal/ngbd-cannot-locate-job-modal.component';
import { NgbdSignOffJobModalComponent } from '../../jobs/ngbd-sign-off-job-modal/ngbd-sign-off-job-modal.component';
import { NgbdViewDetailsJobModalComponent } from '../../jobs/ngbd-view-details-job-modal/ngbd-view-details-job-modal.component';
...
export class JobDetailsComponent implements OnInit {
  ...
  openSignOffModal(job: JobDetail): void {
    ...
    modalRef.result.then((result) => {
      ...
      console.log('❌ Sign-off cancelled or failed:', error);
    });
  }
