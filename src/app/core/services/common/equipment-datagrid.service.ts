...
export class EquipmentDatagridService {
  private readonly COLUMN_STORAGE_KEY = 'userEquipmentColumn';
  ...
  private getDefaultColumns(): ColumnHeaderModel[] {
    return [
      ...
      },
      {
        ...
        technicalName: 'departmentName',
        visible: true,
        selected: true
      },
      {
        prettyName: 'Eqipment Type',
        technicalName: 'equipmentTypeName',
        visible: true,
        selected: true
      },
      {
      ...
      },
      {
        ...
        technicalName: 'postCode',
        visible: true,
        selected: true
      },
      {
        prettyName: 'Service Due Date',
        technicalName: 'lastServiceExpiryDate',
        visible: true,
        selected: true
      },
      {
