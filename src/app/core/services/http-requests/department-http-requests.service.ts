...
export class DepartmentHttpRequestsService {
  ...
  getGridData(params: any, forceRefresh: boolean = false): Observable<any> {
    ...
    const url = `${this.baseUrl}Department/find/`;
  ...
  getGridDataCount(params: any, forceRefresh: boolean = false, isEngineer: boolean = true): Observable<number> {
    ...
    const url = `${this.baseUrl}Department/count/`;
  ...
  addDepartment(department: any): Observable<any> {
    ...
    return this.http.post(url, department, this.getHttpOptions());
  }

  editDepartment(department: any): Observable<any> {
    const url = `${this.baseUrl}Department`;
    return this.http.put(url, department, this.getHttpOptions());
  }
}