...
import { MENUENGINEER } from './menu-engineer';
import { MENUSUPERADMIN } from './menu-super-admin';
...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Menu Items
    this.menuItems = MENUSUPERADMIN;
    this.currentUser = JSON.parse(localStorage.getItem('currentUser') || '{}');
    if(this.currentUser.role[0] == 'Manager') {
      this.menuItems = MENUMANAGER;
    } else if(this.currentUser.role[0] == 'Engineer') {
      this.menuItems = MENUENGINEER;
    } else {
      // this.menuItems = MENUMANAGER;
      this.menuItems = MENUSUPERADMIN;
    }
