...
@Component({
  selector: 'app-my-not-presented-jobs',
  templateUrl: './my-not-presented-jobs.component.html',
  styleUrls: ['./my-not-presented-jobs.component.scss']
})
export class MyNotPresentedJobsComponent implements OnInit {
  ...
  gridParameter = {
    jobStatusType: 9,
    Status: 'CannotLocate' // Not Presented
  }
