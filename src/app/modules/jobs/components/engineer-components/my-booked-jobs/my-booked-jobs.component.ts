...
@Component({
  selector: 'app-my-booked-jobs',
  templateUrl: './my-booked-jobs.component.html',
  styleUrls: ['./my-booked-jobs.component.scss']
})
export class MyBookedJobsComponent implements OnInit {
