...
import { NgbdSignOffJobModalComponent } from 'src/app/shared/components/modals/jobs/ngbd-sign-off-job-modal/ngbd-sign-off-job-modal.component';
...
@Component({
  selector: 'app-my-pending-review-jobs',
  templateUrl: './my-pending-review-jobs.component.html',
  styleUrls: ['./my-pending-review-jobs.component.scss']
})
export class MyPendingReviewJobsComponent implements OnInit {
  ...
  gridParameter = {
    jobStatusType: 10, // Pending Review jobs
  }
