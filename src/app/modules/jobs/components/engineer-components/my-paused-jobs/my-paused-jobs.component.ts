...
@Component({
  selector: 'app-my-paused-jobs',
  templateUrl: './my-paused-jobs.component.html',
  styleUrls: ['./my-paused-jobs.component.scss']
})
export class MyPausedJobsComponent implements OnInit {
