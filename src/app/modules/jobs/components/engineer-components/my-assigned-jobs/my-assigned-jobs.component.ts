...
@Component({
  selector: 'app-my-assigned-jobs',
  templateUrl: './my-assigned-jobs.component.html',
  styleUrls: ['./my-assigned-jobs.component.scss']
})
export class MyAssignedJobsComponent implements OnInit {
