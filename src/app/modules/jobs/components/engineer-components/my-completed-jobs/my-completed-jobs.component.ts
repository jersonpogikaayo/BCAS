...
@Component({
  selector: 'app-my-completed-jobs',
  templateUrl: './my-completed-jobs.component.html',
  styleUrls: ['./my-completed-jobs.component.scss']
})
export class MyCompletedJobsComponent implements OnInit {
