...
import { SimpleUser, User } from 'src/app/core/models/user/user.model';
...
@Component({
  ...
  templateUrl: './unassigned-jobs.component.html',
  styleUrls: ['./unassigned-jobs.component.scss']
})
export class UnassignedJobsComponent implements OnInit {
  ...
  gridParameter = {
    jobStatusType: 0, // Unassigned jobs
  }
