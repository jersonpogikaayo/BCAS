...
onFilterPopupRequested() {
    ...
    const processAction = async () => {
      try {
        if (action === 'View Detail') {
          ...
          this.openSignOffModal(job, isBatch);
  ...
  openSignOffModal(job: JobDetail, isBatch: boolean = false): void {
      ...
      modalRef.componentInstance.jobData = job;
      modalRef.componentInstance.isBatch = isBatch;
